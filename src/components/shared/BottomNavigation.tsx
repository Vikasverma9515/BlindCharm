...
//               className="flex flex-col items-center justify-center p-2 text-primary-600 hover:text-primary-700 transition-colors duration-200"
//             >
//               <Sparkles size={20} />
//               <span className="text-xs mt-1 font-medium">Bijli</span>
//             </button>
//             <Link
//               href="/lobby"
