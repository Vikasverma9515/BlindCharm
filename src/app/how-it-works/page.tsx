...
//                       <img
//                         src="/how2.png"
//                         alt="BlindCharm lobby page"
//                         className="h-100 w-auto dark:hidden flex justify-center"
//                       />
      ...
      <div className="pb-18 md:pb-0">
        <main className="pt-16">
          ...
          <section className="py-16 px-4 md:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                BlindCharm helps you meet people who match your personality, not just your looks.
                We focus on building connections that matter.
              </p>
            </div>
          </section>
          ...
          <section className="py-12 px-4 md:px-8">
            <div className="max-w-6xl mx-auto space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Start with your story, not your selfie. Share your passions, hobbies, and what makes you unique. The more authentic you are, the better your matches.
                  </p>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li>• Set your preferences & interests</li>
                    <li>• Share conversation starters</li>
                    <li>• Be authentic for better matches</li>
                  </ul>
                </div>
                {/* Image */}
                <div className="bg-amber-300 dark:bg-yellow-900/20 rounded-3xl p-2 text-center">
                  {/* <img
                    src="/how1.png"
                    alt="Profile creation"
                    className="mx-auto max-h-[500px] w-auto rounded-xl border-4 border-black dark:border-white shadow-black  hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate-accordion-down"
                  /> */}
                  ...
                  >
                    <br />
                    {/* <div className='bg-amber-400 dark:bg-lime-900/20 rounded-sm  text-center'>
                    Create Your Profile
                    </div> */}
                  </DecayCard>
                  <div className="mt-2 text-black dark:text-gray-300 text-sm font-blindcharm-logo">
                    Build your authentic profile
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center md:flex-row-reverse">
                {/* Image */}
                <div className="bg-amber-300 dark:bg-yellow-900/20 rounded-3xl p-6 text-center">
                  {/* <img
                    src="/how2.png"
                    alt="Lobby system"
                  ...
                  >
                    <br />
                    {/* <div className='bg-white dark:bg-lime-900/20 rounded-xl  text-center '>
                    Create Your Profile
                    </div> */}
                  </DecayCard>
                  <div className="mt-2 text-black dark:text-gray-300 text-sm font-blindcharm-logo">
                    Join the BlindCharm lobby
                  </div>
                </div>
                {/* Text */}
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Connect without the pressure of photos. Our interactive lobby lets you chat, play games, and bond based on vibes first.
                  </p>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li>• Fun icebreakers & activities</li>
                    <li>• Anonymous but engaging conversations</li>
                    <li>• Discover people who share your energy</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Everday the matchmaking happens at 12 and 6 Pm, Where Users are matched with the opposite gender based on their interests and preferences. 
                    {/* When the vibes click, take it further. If both feel the spark, unlock each other’s photos and chat privately. */}
                  </p>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li>• Matched Users can privately chat</li>
                    <li>• Can send voice and request voice message to check the other person is genuine</li>
                    <li>• When both choose to reveal their identity, they can see each other profile</li>
                  </ul>
                </div>
                {/* Image */}
                <div className="bg-amber-300 dark:bg-red-900/20 rounded-3xl p-6 text-center">
                  {/* <img
                    src="/how3.png"
                    alt="Private chat match reveal"
                    className="mx-auto max-h-[400px] w-auto"
                  /> */}
                  <DecayCard
                    width={300}
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center md:flex-row-reverse">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    From online chats to real-life stories — plan dates, keep talking, and nurture a genuine connection.
                  </p>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li>• Move to private conversations</li>
                    <li>• Plan real-world dates</li>
                    <li>• Build a lasting bond</li>
                  </ul>
                </div>
              </div>
          ...
          <section className="py-16 px-4 md:px-8 bg-gray-50 dark:bg-gray-800">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                Why BlindCharm Works
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
                Our method is backed by relationship psychology and real success stories from people who found love through connection first.
              </p>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 shadow">
                  <Eye className="w-10 h-10 text-red-500 mx-auto mb-3" />
                  <h3 className="text-lg font-bold mb-2">Reduces Bias</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Without photos at the start, we remove superficial judgments and encourage deeper bonds.
                  </p>
                </div>

                <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 shadow">
                  <MessageCircle className="w-10 h-10 text-yellow-500 mx-auto mb-3" />
                  <h3 className="text-lg font-bold mb-2">Better Conversations</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Focus on meaningful dialogue, leading to stronger emotional compatibility.
                  </p>
                </div>

                <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 shadow">
                  <Heart className="w-10 h-10 text-red-600 mx-auto mb-3" />
                  <h3 className="text-lg font-bold mb-2">Lasting Relationships</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Matches built on compatibility are more stable and fulfilling long-term.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 px-4 md:px-8 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
              Join thousands of users who’ve built meaningful connections through BlindCharm.
            </p>
            <Link
              href="/register"
              className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              <Heart className="w-5 h-5" />
              Start Your Journey
              <ArrowRight className="w-5 h-5" />
