...
import { getSwipeQueueAction } from '@/app/(ai-dating)/galaxy/actions';
import { DEMO_MODE, MOCK_STORY_CARDS } from '@/lib/demoData';
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (DEMO_MODE) {
            // Everything is served up-front (see /galaxy's initialFeed); no further pages.
