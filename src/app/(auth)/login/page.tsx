...
// export default function LaunchingFridayPage() {
//   return (
...
//           <h1 className="text-2xl md:text-3xl font-semibold text-red-600 tracking-wide">
//             BLINDCHARM
//           </h1>
//         </div> */}
...
//         {/* Main FRIDAY */}
//         <div className="mb-16 md:mb-24">
//           <h2 className="text-8xl md:text-9xl lg:text-[12rem] font-black text-gray-900 leading-none tracking-tight">
//             FRIDAY
//           </h2>
//         </div>
...
//         {/* Bottom BlindCharm */}
//         <div>
//           <h3 className="text-2xl md:text-3xl font-blindcharm-logo text-red-600 tracking-wide">
//             Kabhi kabhi intezaar bhi zaroori hota hai,
// Jo cheez der se mile…
// Woh dil ke aur kareeb lagti hai.
//           </h3>
//         </div>
