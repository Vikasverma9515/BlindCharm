...
import DailyPickCard from '@/features/ai-dating/components/discovery/DailyPickCard';
import Image from 'next/image';
import PickDetailView from '@/features/ai-dating/components/discovery/PickDetailView';
import { Sparkles, Clock, RefreshCw } from 'lucide-react';
import { resetUserHistoryAction, swipeAction } from '@/app/(ai-dating)/galaxy/actions';
