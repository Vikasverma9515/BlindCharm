...
import { getAdminReportsAction, resolveReportAction } from '@/app/(ai-dating)/galaxy/actions';
...
export default function AdminDashboard() {
    ...
    const openInvestigation = async (matchId: string, report: Report) => {
        ...
        try {
            const { getFullMatchChatHistoryAction } = await import('@/app/(ai-dating)/galaxy/actions');
